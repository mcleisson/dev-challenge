...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { approval: @credit.approval, user_id: @credit.user_id, value: @credit.value } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { approval: @credit.approval, user_id: @credit.user_id, value: @credit.value } }
